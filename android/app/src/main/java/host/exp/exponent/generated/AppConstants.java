...
public class AppConstants {
  ...
  public static String INITIAL_URL = "exp://exp.host/@justinbot/flock";
  public static final boolean IS_DETACHED = true;
  public static final String SHELL_APP_SCHEME = "flock";
  ...
  static {
    List<Constants.EmbeddedResponse> embeddedResponses = new ArrayList<>();
        ...
        embeddedResponses.add(new Constants.EmbeddedResponse("https://exp.host/@justinbot/flock/index.exp", "assets://shell-app-manifest.json", "application/json"));
        embeddedResponses.add(new Constants.EmbeddedResponse("https://d1wp6m56sqw74a.cloudfront.net/%40justinbot%2Fflock%2F1.0.0%2Ff3e0430ae4f94b4f4d8f0121a2fdc939-30.0.0-android.js", "assets://shell-app.bundle", "application/javascript"));
